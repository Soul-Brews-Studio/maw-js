 ...
 * TCP on :1883 for agents/peers, WebSocket on :9883 for browsers.
 * Prefer system mosquitto; this is the Aedes fallback.
 *
 * Uses sync Aedes constructor (not createBroker) for PM2 compatibility.
 */
...
// --- Aedes broker (async createBroker — required by aedes v1.x) ---
...
async function startBroker() {
  ...
  // --- WebSocket listener (:9883) for browsers ---
