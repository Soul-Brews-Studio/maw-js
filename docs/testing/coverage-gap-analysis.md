...
| 6 | medium | other | `src/api/sessions.ts` | 372 | 16.8% | 12.5% | partial coverage |
| 7 | low | vendor plugins | `src/vendor/mpr-plugins/cleanup/internal/prune-stale-oracles.ts` | 366 | 0.0% | n/a | absent from LCOV |
